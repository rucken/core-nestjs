...
export class Init1524197725191 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "group" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(100) NOT NULL, "title" varchar(255) NOT NULL, CONSTRAINT "UQ_GROUP_NAME" UNIQUE ("name"), CONSTRAINT "UQ_GROUP_TITLE" UNIQUE ("title"))`);
