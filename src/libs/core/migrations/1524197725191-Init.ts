...
export class Init1524197725191 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_permission" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(100) NOT NULL, "title" varchar(255) NOT NULL, "content_type_id" integer, CONSTRAINT "FK_cc841779d8a08db653e6480a07a" FOREIGN KEY ("content_type_id") REFERENCES "content_type" ("id"))`
    );
    await queryRunner.query(
      `INSERT INTO "temporary_permission"("id", "name", "title", "content_type_id") SELECT "id", "name", "title", "content_type_id" FROM "permission"`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_user_groups" ("user_id" integer NOT NULL, "group_id" integer NOT NULL, CONSTRAINT "FK_95bf94c61795df25a5154350102" FOREIGN KEY ("user_id") REFERENCES "user" ("id"), CONSTRAINT "FK_4c5f2c23c34f3921fbad2cd3940" FOREIGN KEY ("group_id") REFERENCES "group" ("id"), PRIMARY KEY ("user_id", "group_id"))`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `INSERT INTO "permission"("id", "name", "title", "content_type_id") SELECT "id", "name", "title", "content_type_id" FROM "temporary_permission"`
    );
