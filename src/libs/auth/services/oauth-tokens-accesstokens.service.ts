...
import { CORE_CONFIG_TOKEN, ICoreConfig, UsersService } from '@rucken/core-nestjs';
...
export class OauthTokensAccesstokensService {
    ...
    async findAll(options: {
        ...
        try {
            ...
            options.sort = options.sort && (new OauthTokensAccesstoken()).hasOwnProperty(options.sort.replace('-', '')) ? options.sort : '-id';
